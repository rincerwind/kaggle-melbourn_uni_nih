...
train1_filename = maybe_download('https://www.kaggle.com/c/melbourne-university-seizure-prediction/data/', 'train_1.zip', '..\\..\\data\\downloads')
test1_filename = maybe_download('https://www.kaggle.com/c/melbourne-university-seizure-prediction/data/', 'test_1.zip', '..\\..\\data\\downloads')

train1_folders = maybe_extract(train1_filename, '..\\..\\data\\raw')
test1_folders = maybe_extract(test1_filename, '..\\..\\data\\raw')
